...
Item.prototype.generate = function(pos, level){
    ...
    this.spritesheet = new Spritesheet("resources/images/itemIcons.png", 16, 16, "#actors .item:last-child", 20, 20)
...
function Crate(pos, item){
    ...
    this.spritesheet = new Spritesheet("resources/images/crate.png", 25, 25, "#actors .crate:last-child", 30, 30)
...
function Attack(weapon, character){
    ...
    if (this.sprites){
        ...
        this.spritesheet = new Spritesheet("resources/images/Weapons.png", 32, 32, "#attacks div:last-child", 50, 50)
...
function runGame(map, P1, P2) {
	...
	level.P1 = new Character(P1, "resources/images/" + P1 + ".png", P1keys , new Vector(150, 15), new Vector(40, 40), level)
	level.P2 = new Character(P2, "resources/images/" + P2 + ".png", P2keys , new Vector(600, 15), new Vector(40, 40), level)
